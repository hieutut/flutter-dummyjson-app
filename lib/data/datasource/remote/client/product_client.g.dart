...
class _ProductClient implements ProductClient {
  ...
  @override
  Future<ListProductResponse> getProductList({
    RequestParam? param = const RequestParam(),
  }) async {
    ...
    final _options = _setStreamType<ListProductResponse>(
    ...
    late ListProductResponse _value;
    try {
      _value = ListProductResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
